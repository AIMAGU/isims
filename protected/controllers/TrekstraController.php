...
class TrekstraController extends Controller
{
	/**
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Trekstra']))
		{
			...
			if($model->save())
				...
				$this->redirect(array('view','id'=>$model->id_tranekstra));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Trekstra');
	...
	{
		$model=new Trekstra('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Trekstra']))
			$model->attributes=$_GET['Trekstra'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tr-ekstra-form')
		{
