...
<div id="header">
		<!-- <div id="art-flash-area">
                    ...
                    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1000" height="250" id="art-flash-object">
                        <param name="movie" value="<?php //echo Yii::app()->request->baseUrl; ?>/css/flash.swf">
                        <param name="quality" value="high">
                    	<param name="scale" value="exactfit">
                    	<param name="wmode" value="transparent">
                    	<param name="flashvars" value="color1=0xFFFFFF&amp;alpha1=.90&amp;framerate1=24&amp;loop=true&amp;wmode=transparent">
                        <param name="swfliveconnect" value="true">
                        
                        <object type="application/x-shockwave-flash" data="<?php //echo Yii::app()->request->baseUrl; ?>/css/flash.swf" width="1000" height="250">
                            <param name="quality" value="high">
                    	    <param name="scale" value="exactfit">
                            <param name="wmode" value="transparent">
                            <param name="flashvars" value="color1=0xFFFFFF&amp;alpha1=.90&amp;framerate1=24&amp;loop=true&amp;wmode=transparent">
