	...
	function read($sFileName) {
		...
		if($res === false) {
			...
			if($this->_ole->error == 1) {
				...
				alert("Data gagal di import. Pastikan ekstensi file anda adalah .xls (Microsof Excel 2003/95, etc)");
				window.location = "nilai-ImportExcel.html"
				</script>');
				//Maaf, untuk file <i>' . $sFileName . '</i> tidak bisa terbaca.<br> Pastikan anda menggunakan file dengan ekstensi .xls');
			}
